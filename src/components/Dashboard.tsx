    ...
    <section className="py-20 bg-gradient-to-br from-green-50 to-emerald-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between mb-8 animate-fade-in-up">
          <div>
            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Your Eco Profile</h1>
        ...
        {/* Tabs */}
        <div className="flex gap-2 mb-6 bg-white rounded-2xl p-1 border border-green-100 w-fit animate-fade-in-up delay-100">
          ...
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {stats.map((stat, i) => (
                <div
                  key={stat.label}
                  className="bg-white rounded-2xl p-5 border border-green-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all"
            ...
            <div className="bg-white rounded-2xl p-6 border border-green-100 shadow-sm">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Items by Category</h3>
        ...
        {tab === 'history' && (
          <div className="animate-fade-in">
            <div className="bg-white rounded-2xl p-6 border border-green-100 shadow-sm">
              ...
              <p className="text-gray-500">Scan history will appear here after your first scan.</p>
            </div>
          </div>
        )}
            ...
            <div className="bg-white rounded-2xl p-6 border border-green-100 shadow-sm">
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  <span className="text-gray-700">Receive email updates on eco tips</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" defaultChecked className="w-5 h-5 rounded" />
                  <span className="text-gray-700">Show my stats on community board</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer">
