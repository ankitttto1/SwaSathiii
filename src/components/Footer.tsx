export default function Footer() {
  ...
  return (
    <footer className="bg-green-900 dark:bg-green-950 text-white border-t border-green-800 dark:border-green-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl tracking-tight">SwachhSaathi</span>
            </div>
        ...
        <div className="border-t border-green-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-green-200/50">
          <p>&copy; {year} SwachhSaathi. All rights reserved.</p>
